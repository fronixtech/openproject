# -*- encoding: utf-8 -*-
# stub: omniauth-openid-connect 0.4.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.files = [".gitignore".freeze, ".travis.yml".freeze, "Gemfile".freeze, "Guardfile".freeze, "LICENSE.txt".freeze, "README.md".freeze, "Rakefile".freeze, "lib/omniauth/openid_connect.rb".freeze, "lib/omniauth/openid_connect/errors.rb".freeze, "lib/omniauth/openid_connect/version.rb".freeze, "lib/omniauth/strategies/openid_connect.rb".freeze, "lib/omniauth/strategies/openid_connect/claims.rb".freeze, "lib/omniauth/strategies/openid_connect/user_info_amendments.rb".freeze, "lib/omniauth_openid_connect.rb".freeze, "omniauth-openid-connect.gemspec".freeze, "test/fixtures/id_token.txt".freeze, "test/fixtures/jwks.json".freeze, "test/fixtures/test.crt".freeze, "test/lib/omniauth/strategies/openid_connect_test.rb".freeze, "test/strategy_test_case.rb".freeze, "test/test_helper.rb".freeze]
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_development_dependency(%q<mocha>.freeze, ["~> 1.11", ">= 1.11.2"])
    ...
    s.add_dependency(%q<mocha>.freeze, ["~> 1.11", ">= 1.11.2"])
