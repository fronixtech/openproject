# -*- encoding: utf-8 -*-
# stub: sentry-delayed_job 5.2.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<sentry-ruby-core>.freeze, ["~> 5.2.1"])
    s.add_runtime_dependency(%q<delayed_job>.freeze, [">= 4.0"])
  else
    s.add_dependency(%q<sentry-ruby-core>.freeze, ["~> 5.2.1"])
    s.add_dependency(%q<delayed_job>.freeze, [">= 4.0"])
  end
end
